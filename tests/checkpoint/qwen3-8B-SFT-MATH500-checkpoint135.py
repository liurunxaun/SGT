...
# ================= 参数配置 =================
# sglang推理结果
inference_output_path = "/data/home/the/rxliu/projects/open-r1-main/tests/results/inference-qwen3-8B-SFT-MATH500-checkpoint135-20251201-2300.xlsx"

# sglang 推理参数
dataset_path = "/ssd5/rxliu/datasets/MATH-500/test.parquet"
system_prompt = ""
query_field = "problem"
model = "qwen3-8B-SFT-checkpoint135"
temperature = 0.6
max_tokens = 32768
...
# 测试结果   
result_output_path = "/data/home/the/rxliu/projects/open-r1-main/tests/results/result-qwen3-8B-SFT-MATH500-checkpoint135-20251201-2300.xlsx" 
