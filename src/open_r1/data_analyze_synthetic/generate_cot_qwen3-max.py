...
# *** 主要修改点：移除 extra_body 和 reasoning_content 提取逻辑 ***
async def get_qwen_response_async(client, prompt):
    ...
    try:
        response = await client.chat.completions.create(
            ...
            messages=messages,
            # 移除 extra_body={"enable_thinking": True}
            stream=False, 
        ...
        # qwen3-max 不提供 reasoning_content，直接设为空
        reasoning = ""
    ...
    async with sem:
        ...
        for attempt in range(1, MAX_ATTEMPTS + 1):
            ...
            record = {
                ...
                "attempt": attempt,
                "qwen_reasoning": reasoning, # reasoning 字段现在将是空或错误信息
                "qwen_answer": answer,
...
async def main():
    ...
    print("="*60)
    # *** 修改点 3：更新打印信息中的模型名称 ***
    print(f"🚀 全速启动 | 模型: {GEN_MODEL_NAME} | 并发: {MAX_CONCURRENCY} | MaxTokens: {MAX_TOKENS}")
