...
if __name__ == "__main__":
    xlsx_path = "/ssd5/rxliu/datasets/SFT-Data/result_data_Olympids_hard_qwen3-max_solution.xlsx"
    json_path = "/ssd5/rxliu/datasets/SFT-Data/result_data_Olympids_hard.json"    
